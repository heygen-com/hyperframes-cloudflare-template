/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ea30927489155ff39bb33553d1e17e0c)
// Runtime types generated with workerd@1.20260722.1 2026-04-01 nodejs_compat
interface __BaseEnv_Env {
	RENDERS: R2Bucket;
	ASSETS: Fetcher;
	ENABLE_AI_GEN: "true";
	RENDER_CONTAINER: DurableObjectNamespace<import("./src/server").RenderContainer>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "RenderContainer";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENABLE_AI_GEN">> {}
}
